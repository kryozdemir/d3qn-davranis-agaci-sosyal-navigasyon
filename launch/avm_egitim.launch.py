...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('senaryo', default_value=os.path.join(paket, 'config', 'senaryo_ayarlari', 'avm.yaml')),
        DeclareLaunchArgument('bt_aktif', default_value='true'),
        DeclareLaunchArgument('world', default_value=os.path.join(paket, 'worlds', 'avm.world')),
        gazebo,
        node
    ])
